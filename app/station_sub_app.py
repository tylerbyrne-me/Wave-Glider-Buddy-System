...
station_api = FastAPI()
print(f"DEBUG_PRINT: station_sub_app.py - station_api instance created: {type(station_api)}")
...
async def sub_app_minimal_test_endpoint():
    print("DEBUG_PRINT: station_sub_app.py - /sub_app_minimal_test endpoint was called!")
    return {"message": "Sub-application minimal test route is working!"}
print("DEBUG_PRINT: station_sub_app.py - /sub_app_minimal_test definition processed by Python interpreter.")